namespace AvalonStudio.Languages.CPlusPlus
{
    public class ClangFormatSettings
    {
        public static ClangFormatSettings Default
        {
            get
            {
                ClangFormatSettings result = new ClangFormatSettings();
        ...
        {
            return (ClangFormatSettings)this.MemberwiseClone();
        }
        ...
        public override string ToString()
        {
            return string.Format(formatString.Replace("\r\n", ""),
                ...
                SpaceBeforeParenthesis.ToString(),
